...
export default function AppLayoutFixed({ children }: { children: React.ReactNode }) {
  ...
  const title = useMemo<Title>(() => {
    switch (pathname) {
      case '/':
        return { title: 'Painel Executivo', subtitle: 'Visão geral do posto  - Unidade Central' };
      case '/prices':
      ...
      default:
        return { title: 'Fuel', subtitle: 'Sistema de Gestão' };
    }
  }, [pathname]);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'logo-text' },
          React.createElement('h1', null, 'ValorEmRede'),
